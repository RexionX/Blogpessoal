...
//definir a porta utilizada para os teste - que sera uma porta aleatório
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@TestInstance(TestInstance.Lifecycle.PER_CLASS)//cilco de vida do teste definido por classe
