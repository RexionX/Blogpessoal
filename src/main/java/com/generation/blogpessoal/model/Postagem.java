...
public class Postagem {
	...
	@NotBlank(message= "Atributo título é obrigatório")//atributos não passados ou referenciados na hora do cadastro
	private String titulo;
	
	@Size(min= 10, max= 1000, message = "O texto deve ter no minimo 10 caracteres e no maximo 1000")
	@NotBlank(message= "Atributo texto é obrigatório")//atributos não passados ou referenciados na hora do cadastro
