...
//falar para segurança quais são as informações que vamos usar para login
	...
	//essa classe consegue passar os níveis de acesso de um usuario
	
	
	//metodo construtor está passando o usuario e senha informados para os atributos dessa classe
